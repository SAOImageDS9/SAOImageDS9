...
proc CreateIconsBottomBin {} {
	...
	-image [image create photo -file "$ds9(root)/icons/ui/bin_increase.png"]
	...
	-image [image create photo -file "$ds9(root)/icons/ui/bin_one.png"]
    tooltip::tooltip $mb.binone [msgcat::mc {Set Bin to 1}]

    ttk::button $mb.bindecrease -takefocus 0 -command [list Bin 2 2] \
	-image [image create photo -file "$ds9(root)/icons/ui/bin_decrease.png"]
...
proc CreateIconsBottomBlock {} {
	...
	-image [image create photo -file "$ds9(root)/icons/ui/block_increase.png"]
	...
	-image [image create photo -file "$ds9(root)/icons/ui/block_one.png"]
    tooltip::tooltip $mb.blockone [msgcat::mc {Set Block to 1}]

    ttk::button $mb.blockdecrease -takefocus 0 -command [list Block 2 2] \
	-image [image create photo -file "$ds9(root)/icons/ui/block_decrease.png"]
...
proc CreateIconsBottomZoom {} {
	...
	-image [image create photo -file "$ds9(root)/icons/ui/zoom_plus.png"]
	...
	-image [image create photo -file "$ds9(root)/icons/ui/zoom_one.png"]
...
proc CreateIconsBottomFrame {} {
	...
	-image [image create photo -file "$ds9(root)/icons/ui/frame_next.png"]
    tooltip::tooltip $mb.next [msgcat::mc {Goto Next Frame}]

    ttk::button $mb.last -takefocus 0 -command LastFrame \
	-image [image create photo -file "$ds9(root)/icons/ui/frame_last.png"]
...
proc CreateIconsBottomView {} {
	...
	-image [image create photo -file "$ds9(root)/icons/ui/view_vertical.png"]
	...
	-image [image create photo -file "$ds9(root)/icons/ui/view_horizontal.png"]
	...
	-image [image create photo -file "$ds9(root)/icons/ui/view_colorbar.png"]
