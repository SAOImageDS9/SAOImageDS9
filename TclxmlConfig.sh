...
# build directory.
Tclxml_BUILD_LIB_SPEC='-L/Users/joye/saods9/tclxml-3.2 -lTclxml3.2'

# String to pass to linker to pick up the Tclxml library from its
# installed directory.
Tclxml_LIB_SPEC='-L/Users/joye/saods9/lib/Tclxml3.2 -lTclxml3.2'
...
# build directory.
Tclxml_BUILD_STUB_LIB_SPEC='-L/Users/joye/saods9/tclxml-3.2 -lTclxmlstub3.2'

# String to pass to linker to pick up the Tclxml stub library from its
# installed directory.
Tclxml_STUB_LIB_SPEC='-L/Users/joye/saods9/lib/Tclxml3.2 -lTclxmlstub3.2'

# String to pass to linker to pick up the Tclxml stub library from its
# build directory.
Tclxml_BUILD_STUB_LIB_PATH='/Users/joye/saods9/tclxml-3.2/'

# String to pass to linker to pick up the Tclxml stub library from its
# installed directory.
Tclxml_STUB_LIB_PATH='/Users/joye/saods9/lib/Tclxml3.2/'

# String to pass to the compiler so that an extension can find
# installed header.
Tclxml_INCLUDE_SPEC='-I/Users/joye/saods9/include'
