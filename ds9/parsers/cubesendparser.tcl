    ...
    while {$accepted == 0} {
        ...
        switch -- $table($state:$token) {
            ...
            reduce {
                ...
                switch -- $rule {
                    1 { ProcessSendCmdCurrent "get fits slice" }
                    2 { ProcessSendCmdGet cube lock }
                    3 { BlinkSendCmdInterval }
                    6 { ProcessSendCmdTxt "2" }
                    7 { ProcessSendCmdGet cube axes }
                    8 { ProcessSendCmdYesNo cube lock,axes }
                }
                unsetupvalues $dc
