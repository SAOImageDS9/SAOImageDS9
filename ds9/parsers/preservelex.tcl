...
#   -- from the flex(1) man page
proc preserve::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc preserve::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc preserve::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
