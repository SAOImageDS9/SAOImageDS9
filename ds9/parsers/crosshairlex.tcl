...
#   -- from the flex(1) man page
proc crosshair::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc crosshair::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc crosshair::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc crosshair::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
