...
#   -- from the flex(1) man page
proc mosaicimagewfpc2::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc mosaicimagewfpc2::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc mosaicimagewfpc2::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc mosaicimagewfpc2::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
# appropriately.
#   -- from the flex(1) man page
proc mosaicimagewfpc2::yyless {n} {
    variable yy_current_buffer
    variable index_
    variable yytext
    variable yyleng
