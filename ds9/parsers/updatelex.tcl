...
#   -- from the flex(1) man page
proc update::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc update::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc update::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
set NOW_ 265
    ...
    while {1} {
        ...
        set matched_rule -1
        # rule 0: now
        if {[regexp -start $index_ -indices -line -nocase -- {\A(now)} $yy_current_buffer match] > 0 && \
