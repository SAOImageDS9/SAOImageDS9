...
#   -- from the flex(1) man page
proc skyviewsend::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc skyviewsend::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc skyviewsend::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc skyviewsend::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
set PIXELS_ 263
    ...
    while {1} {
        ...
        set matched_rule -1
        # rule 0: pixels
        if {[regexp -start $index_ -indices -line -nocase -- {\A(pixels)} $yy_current_buffer match] > 0 && \
