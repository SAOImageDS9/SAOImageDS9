...
#include "framergbtruecolor8.h"

// Tk Canvas Widget Function Declarations

int FrameRGBTrueColor8CreateProc(Tcl_Interp*, Tk_Canvas, Tk_Item*,
...
FrameRGBTrueColor8::FrameRGBTrueColor8(Tcl_Interp* i, Tk_Canvas c, 
					 Tk_Item* item)
  : FrameRGB(i,c,item), TrueColor8(visual)
{
