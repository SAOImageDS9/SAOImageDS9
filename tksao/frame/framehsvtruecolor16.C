...
#include "framehsvtruecolor16.h"
#include "fitsimage.h"

// Tk Canvas Widget Function Declarations

int FrameHSVTrueColor16CreateProc(Tcl_Interp*, Tk_Canvas, Tk_Item*, int, 
				  Tcl_Obj *const []);

// FrameHSVTrueColor16 Specs

static Tk_CustomOption tagsOption = {
  NULL, NULL, NULL
};

static Tk_ConfigSpec frameHSVTrueColor16Specs[] = {
  {TK_CONFIG_STRING, (char*)"-command", NULL, NULL, "framehsv",
...
static Tk_ItemType frameHSVTrueColor16Type = {
  (char*)"framehsvtruecolor16",           // name
  sizeof(WidgetOptions),        // item size
  FrameHSVTrueColor16CreateProc,   // configProc
  frameHSVTrueColor16Specs,        // configSpecs
...
int FrameHSVTrueColor16_Init(Tcl_Interp* interp)
{
  tagsOption.parseProc = Tk_CanvasTagsParseProc;
  tagsOption.printProc = Tk_CanvasTagsPrintProc;

  Tk_CreateItemType(&frameHSVTrueColor16Type);
  return TCL_OK;
}

int FrameHSVTrueColor16CreateProc(Tcl_Interp* interp, Tk_Canvas canvas, 
				  Tk_Item* item, int argc, 
				  Tcl_Obj *const argv[])
{
  FrameHSVTrueColor16* frame = new FrameHSVTrueColor16(interp, canvas, item);
...
// FrameHSVTrueColor16 Member Functions

FrameHSVTrueColor16::FrameHSVTrueColor16(Tcl_Interp* i, Tk_Canvas c, 
					 Tk_Item* item)
  : FrameHSV(i,c,item), TrueColor16(visual)
{
  configSpecs = frameHSVTrueColor16Specs;  // frame configure options
}

FrameHSVTrueColor16::~FrameHSVTrueColor16()
{
