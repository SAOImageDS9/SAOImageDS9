...
#   -- from the flex(1) man page
proc zscalesend::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc zscalesend::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc zscalesend::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc zscalesend::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
set LINE_ 259
    ...
    while {1} {
        ...
        set matched_rule -1
        # rule 0: contrast
        if {[regexp -start $index_ -indices -line -nocase -- {\A(contrast)} $yy_current_buffer match] > 0 && \
