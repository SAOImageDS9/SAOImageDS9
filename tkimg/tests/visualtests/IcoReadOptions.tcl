...
# Determine the number of pages of the ICO file and compare with metadata "numpages".
...
# Extract all pages of the ICO file and display in a label.
for { set n 0 } { $n < $numPages } { incr n } {
    set img($n) [image create photo -file $imgFile -format [list ICO -verbose true -index $n]]
    label .img_$n -image $img($n) -compound top -relief ridge -text "ICO -index $n"
