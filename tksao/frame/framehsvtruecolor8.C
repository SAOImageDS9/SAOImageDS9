...
#include "framehsvtruecolor8.h"
#include "fitsimage.h"

// Tk Canvas Widget Function Declarations

int FrameHSVTrueColor8CreateProc(Tcl_Interp*, Tk_Canvas, Tk_Item*, int, 
				  Tcl_Obj *const []);

// FrameHSVTrueColor8 Specs

static Tk_CustomOption tagsOption = {
  NULL, NULL, NULL
};

static Tk_ConfigSpec frameHSVTrueColor8Specs[] = {
...
static Tk_ItemType frameHSVTrueColor8Type = {
  (char*)"framehsvtruecolor8",           // name
  sizeof(WidgetOptions),        // item size
  FrameHSVTrueColor8CreateProc,   // configProc
  frameHSVTrueColor8Specs,        // configSpecs
...
int FrameHSVTrueColor8_Init(Tcl_Interp* interp)
{
  tagsOption.parseProc = Tk_CanvasTagsParseProc;
  tagsOption.printProc = Tk_CanvasTagsPrintProc;

  Tk_CreateItemType(&frameHSVTrueColor8Type);
  return TCL_OK;
}

int FrameHSVTrueColor8CreateProc(Tcl_Interp* interp, Tk_Canvas canvas, 
				  Tk_Item* item, int argc, 
				  Tcl_Obj *const argv[])
{
  FrameHSVTrueColor8* frame = new FrameHSVTrueColor8(interp, canvas, item);
...
// FrameHSVTrueColor8 Member Functions

FrameHSVTrueColor8::FrameHSVTrueColor8(Tcl_Interp* i, Tk_Canvas c, 
					 Tk_Item* item)
  : FrameHSV(i,c,item), TrueColor8(visual)
{
  configSpecs = frameHSVTrueColor8Specs;  // frame configure options
}

FrameHSVTrueColor8::~FrameHSVTrueColor8()
{
