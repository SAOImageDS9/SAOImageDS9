...
#   -- from the flex(1) man page
proc nressend::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc nressend::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc nressend::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
