...
#include "framemulticolortruecolor8.h"

int FrameMultiColorTrueColor8CreateProc(Tcl_Interp*, Tk_Canvas, Tk_Item*,
...
static Tk_ConfigSpec frameMultiColorTrueColor8Specs[] = {
...
static Tk_ItemType frameMultiColorTrueColor8Type = {
  (char*)"framemulticolortruecolor8",
  sizeof(WidgetOptions),
  FrameMultiColorTrueColor8CreateProc,
  frameMultiColorTrueColor8Specs,
  WidgetConfigProc,
  WidgetCoordProc,
  WidgetDeleteProc,
  WidgetDisplayProc,
...
int FrameMultiColorTrueColor8_Init(Tcl_Interp* interp)
{
  tagsOption.parseProc = Tk_CanvasTagsParseProc;
  tagsOption.printProc = Tk_CanvasTagsPrintProc;

  Tk_CreateItemType(&frameMultiColorTrueColor8Type);
  return TCL_OK;
}

int FrameMultiColorTrueColor8CreateProc(Tcl_Interp* interp, Tk_Canvas canvas,
					Tk_Item* item, Tcl_Size argc,
					Tcl_Obj *const argv[])
{
  FrameMultiColorTrueColor8* frame =
    new FrameMultiColorTrueColor8(interp, canvas, item);
...
FrameMultiColorTrueColor8::FrameMultiColorTrueColor8(Tcl_Interp* i,
						     Tk_Canvas c,
						     Tk_Item* item)
  : FrameMultiColor(i,c,item), TrueColor8(visual)
{
  configSpecs = frameMultiColorTrueColor8Specs;
}

FrameMultiColorTrueColor8::~FrameMultiColorTrueColor8()
{
  unloadAllFits();
}
