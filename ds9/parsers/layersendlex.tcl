...
#   -- from the flex(1) man page
proc layersend::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc layersend::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc layersend::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc layersend::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
