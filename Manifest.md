...
| taccle     | 1.4        | y   |       | https://github.com/wjoye/taccle                                      | previous upstream abandoned     |
| tcl9.0     | **9.0.3**  |     |       | https://github.com/tcltk/tcl                                         | 9.0.3                           |
| tclfitsy   |            | y   |       |                                                                      |                                 |
| tcllib     | **1.2**    |     |       | https://github.com/tcltk/tcllib                                      | 2.0                             |
| tclsignal  | 1.5.0      | y   |       | https://github.com/wjoye/tclsignal                                   | 1.5.0                           |
...
| tkagif     | 1.1        | y   |       | https://github.com/wjoye/tkagif                                      | 1.1                             |
| tkblt      | 3.3        | y   | y     | https://github.com/wjoye/tkblt                                       | previous upstream abandoned (1) |
| tkcon      | 2.8        | y   | y     | https://github.com/wjoye/tkcon                                       | previous upstream abandoned     |
| tkhtml1    | 1.1        | y   | y     | https://github.com/wjoye/tkhtml1                                     | previous upstream abandoned (2) |
| **tkimg**  | 2.0.1      |     |       | https://sourceforge.net/projects/tkimg/                              | 2.1.1 (4)                       |
| tklib      | **0.9**    |     |       | https://github.com/tcltk/tklib                                       | 0.9                             |
| tkmpeg     | 1.1        | y   |       | https://github.com/wjoye/tkmpeg                                      | 1.1                             |
| tksao      |            | y   |       |                                                                      |                                 |
| **tksvg**  | 0.7.2      |     | y     | https://github.com/wjoye/tksvg                                       | 0.7.2 (3)                       |
| tktable    | 2.13       | y   | y     | https://github.com/wjoye/tktable                                     | previous upstream abandoned     |
