...
#   -- from the flex(1) man page
proc twomass::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc twomass::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc twomass::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
