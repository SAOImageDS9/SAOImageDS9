...
proc CommGet {proc id paramlist fn} {
	...
	switch -- $cmd {
	    ...
	    about {
		ProcessSendAboutCmd $proc $id $param {} $fn.txt
		return $fn.txt
	    }
	    align {ProcessSendAlignCmd $proc $id $param}
	    analysis {
		ProcessSendAnalysisCmd $proc $id $param {} $fn.ans
		return $fn.ans
	    }
	    array {
		ProcessSendArrayCmd $proc $id $param {} $fn.arr
		return $fn.arr
	    }
	    bg -
	    background {
	    ...
	    fits {
		ProcessSendFitsCmd $proc $id $param {} $fn.fits
		return $fn.fits
	    }
	    ...
	    gif {
		ProcessSendGIFCmd $proc $id $param {} $fn.gif
		return $fn.gif
	    }
	    ...
	    jpg -
	    jpeg {
		ProcessSendJPEGCmd $proc $id $param {} $fn.jpg
		return $fn.jpg
	    }
	    ...
	    mosaic {
		ProcessSendMosaicCmd $proc $id $param {} $fn.fits
		return $fn.fits
	    }
	    mosaicimage {
		ProcessSendMosaicImageCmd $proc $id $param {} $fn.fits
		return $fn.fits
	    }
	    mosaicwcs {
		# backward compatibility
		ProcessSendMosaicWCSCmd $proc $id $param {} $fn.fits
		return $fn.fits
	    }
	    mosaiciraf {
		# backward compatibility
	    ...
	    mosaicimagewcs {
		# backward compatibility
		ProcessSendMosaicImageWCSCmd $proc $id $param {} $fn.fits
		return $fn.fits
	    }
	    mosaicimageiraf {
		# backward compatibility
	    ...
	    nrrd {
		ProcessSendNRRDCmd $proc $id $param {} $fn.nrrd
		return $fn.nrrd
	    }
	    ...
	    pixeltable {
		ProcessSendPixelTableCmd $proc $id $param {} $fn.pix
		return $fn.pix
	    }
	    plot {ProcessSendPlotCmd $proc $id $param}
	    png {
		ProcessSendPNGCmd $proc $id $param {} $fn.png
		return $fn.png
	    }
	    precision {
		# backward compatibility prefs
	    ...
	    rgbcube {
		ProcessSendRGBCubeCmd $proc $id $param {} $fn.fits
		return $fn.fits
	    }
	    rgbimage {
