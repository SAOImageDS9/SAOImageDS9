...
static Tk_ConfigSpec frameHSVTrueColor24Specs[] = {
...
static Tk_ItemType frameHSVTrueColor24Type = {
  (char*)"framehsvtruecolor24",           // name
  sizeof(WidgetOptions),        // item size
  FrameHSVTrueColor24CreateProc,   // configProc
  frameHSVTrueColor24Specs,        // configSpecs
...
int FrameHSVTrueColor24_Init(Tcl_Interp* interp)
{
  tagsOption.parseProc = Tk_CanvasTagsParseProc;
  tagsOption.printProc = Tk_CanvasTagsPrintProc;

  Tk_CreateItemType(&frameHSVTrueColor24Type);
  return TCL_OK;
}
...
// FrameHSVTrueColor24 Member Functions

FrameHSVTrueColor24::FrameHSVTrueColor24(Tcl_Interp* i, Tk_Canvas c, 
					 Tk_Item* item)
  : FrameHSV(i, c, item), TrueColor24(visual)
{
  configSpecs = frameHSVTrueColor24Specs;  // frame configure options
}

FrameHSVTrueColor24::~FrameHSVTrueColor24()
{
