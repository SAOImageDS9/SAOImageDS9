...
#   -- from the flex(1) man page
proc hlsimage::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc hlsimage::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc hlsimage::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
