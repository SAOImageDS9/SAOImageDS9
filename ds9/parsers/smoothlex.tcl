...
#   -- from the flex(1) man page
proc smooth::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc smooth::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc smooth::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
set TOPHAT_ 279
    ...
    while {1} {
        ...
        # rule 1: boxcar
        if {[regexp -start $index_ -indices -line -nocase -- {\A(boxcar)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 1
        ...
        # rule 3: elliptic
        if {[regexp -start $index_ -indices -line -nocase -- {\A(elliptic)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 3
        ...
        # rule 5: gaussian
        if {[regexp -start $index_ -indices -line -nocase -- {\A(gaussian)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 5
        ...
        # rule 10: radiusminor
        if {[regexp -start $index_ -indices -line -nocase -- {\A(radiusminor)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 10
        ...
        # rule 11: sigma
        if {[regexp -start $index_ -indices -line -nocase -- {\A(sigma)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 11
        ...
        # rule 12: sigmaminor
        if {[regexp -start $index_ -indices -line -nocase -- {\A(sigmaminor)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 12
        ...
        # rule 13: tophat
        if {[regexp -start $index_ -indices -line -nocase -- {\A(tophat)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 13
