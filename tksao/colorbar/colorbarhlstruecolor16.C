...
#include "colorbarhlstruecolor16.h"
...
static Tk_ConfigSpec colorbarHLSTrueColor16Specs[] = {
...
static Tk_ItemType colorbarHLSTrueColor16Type = {
  (char*)"colorbarhlstruecolor16",        // name
  sizeof(ColorbarBaseOptions), // size
  ColorbarHLSTrueColor16CreateProc, // configProc
  colorbarHLSTrueColor16Specs,     // configSpecs
...
int ColorbarHLSTrueColor16_Init(Tcl_Interp* interp)
{
  tagsOption.parseProc = Tk_CanvasTagsParseProc;
  tagsOption.printProc = Tk_CanvasTagsPrintProc;

  Tk_CreateItemType(&colorbarHLSTrueColor16Type);
  return TCL_OK;
}
				     ...
				     Tcl_Obj *const argv[])
{
  ColorbarHLSTrueColor16* colorbar = 
    new ColorbarHLSTrueColor16(interp, canvas, item);
...
// ColorbarHLSTrueColor16

ColorbarHLSTrueColor16::ColorbarHLSTrueColor16(Tcl_Interp* i, Tk_Canvas c, 
					       Tk_Item* item) 
: ColorbarT(i,c,item), ColorbarHLS(i,c,item), ColorbarTTrueColor16(i,c,item)
{
