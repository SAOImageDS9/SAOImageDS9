...
ColorbarHSVTrueColor24::ColorbarHSVTrueColor24(Tcl_Interp* i, Tk_Canvas c, 
					       Tk_Item* item) 
: ColorbarT(i,c,item), ColorbarHSV(i,c,item), TrueColor24(visual)
{
...
void ColorbarHSVTrueColor24::updateColorsVert()
{
...
void ColorbarHSVTrueColor24::updateColors24Horz(int width, int height,
						char* data)
{
...
void ColorbarHSVTrueColor24::updateColors24Vert(int width, int height,
						char* data)
{
  // if we have cross platforms, we need to byte swap
  if ((!xmap->byte_order && lsb()) || (xmap->byte_order && !lsb())) {
...
void ColorbarHSVTrueColor24::updateColors32Horz(int width, int height, 
						char* data)
{
  // if we have cross platforms, we need to byte swap
  unsigned char row[xmap->bytes_per_line];
...
void ColorbarHSVTrueColor24::updateColors32Vert(int width, int height, 
						char* data)
{
  // if we have cross platforms, we need to byte swap
  if ((!xmap->byte_order && lsb()) || (xmap->byte_order && !lsb())) {
