...
proc prismsend::YYABORT {} {
    return -code return 1
}

proc prismsend::YYACCEPT {} {
    return -code return 0
}

proc prismsend::YYERROR {} {
    variable yyerr
    set yyerr 1
}

proc prismsend::yyclearin {} {
    variable token
    variable yycnt
    set token {}
    incr yycnt -1
...
proc prismsend::yyerror {s} {
    puts stderr $s
}

proc prismsend::setupvalues {stack pointer numsyms} {
    upvar 1 1 y
    set y {}
...
proc prismsend::unsetupvalues {numsyms} {
    for {set i 1} {$i <= $numsyms} {incr i} {
        upvar 1 $i y
        unset y
    }
