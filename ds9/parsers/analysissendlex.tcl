...
#   -- from the flex(1) man page
proc analysissend::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc analysissend::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc analysissend::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc analysissend::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
set YESNO_ 268
    ...
    while {1} {
        ...
        set matched_rule -1
        # rule 0: entry
        if {[regexp -start $index_ -indices -line -nocase -- {\A(entry)} $yy_current_buffer match] > 0 && \
