...
#   -- from the flex(1) man page
proc hsvarray::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc hsvarray::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc hsvarray::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
