...
/* Cast the sink function pointer to a pointer to the FORTRAN
   ...
   ( ( void (*)(void*,void*,long int) ) sink )( CHARACTER_ARG(CARD), INTEGER_ARG(&STATUS)
                            TRAIL_ARG(CARD) );
   astSetStatus( STATUS );
}
...
/* Cast the source function pointer to a pointer to the FORTRAN
   ...
   retval = ( *(F77_INTEGER_TYPE (*)(void*,void*,long int)) source )( CHARACTER_ARG(CARD),
                                                  INTEGER_ARG(&STATUS)
                                                  TRAIL_ARG(CARD) );
   astSetStatus( STATUS );
...
/* Invoke the table source function (casting it to the F77 API first) to
   ...
   if( astOK ) {
      ...
      // waj
      // ( ( void (*)() ) tabsource )(
      ( ( void (*)(void*,void*,void*,void*,void*,long int) ) tabsource )(
