...
#include "framehlstruecolor24.h"
#include "fitsimage.h"

// Tk Canvas Widget Function Declarations

int FrameHLSTrueColor24CreateProc(Tcl_Interp*, Tk_Canvas, Tk_Item*, int, 
				  Tcl_Obj *const []);

// FrameHLSTrueColor24 Specs

static Tk_CustomOption tagsOption = {
  NULL, NULL, NULL
};

static Tk_ConfigSpec frameHLSTrueColor24Specs[] = {
...
static Tk_ItemType frameHLSTrueColor24Type = {
  (char*)"framehlstruecolor24",           // name
  sizeof(WidgetOptions),        // item size
  FrameHLSTrueColor24CreateProc,   // configProc
  frameHLSTrueColor24Specs,        // configSpecs
...
int FrameHLSTrueColor24_Init(Tcl_Interp* interp)
{
  tagsOption.parseProc = Tk_CanvasTagsParseProc;
  tagsOption.printProc = Tk_CanvasTagsPrintProc;

  Tk_CreateItemType(&frameHLSTrueColor24Type);
  return TCL_OK;
}

int FrameHLSTrueColor24CreateProc(Tcl_Interp* interp, Tk_Canvas canvas, 
				  Tk_Item* item, int argc, 
				  Tcl_Obj *const argv[])
{
  FrameHLSTrueColor24* frame = new FrameHLSTrueColor24(interp, canvas, item);
...
// FrameHLSTrueColor24 Member Functions

FrameHLSTrueColor24::FrameHLSTrueColor24(Tcl_Interp* i, Tk_Canvas c, 
					 Tk_Item* item)
  : FrameHLS(i, c, item), TrueColor24(visual)
{
  configSpecs = frameHLSTrueColor24Specs;  // frame configure options
}

FrameHLSTrueColor24::~FrameHLSTrueColor24()
{
