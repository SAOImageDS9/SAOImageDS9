...
proc masksend::YYABORT {} {
    return -code return 1
}

proc masksend::YYACCEPT {} {
...
proc masksend::yyerror {s} {
    puts stderr $s
}

proc masksend::setupvalues {stack pointer numsyms} {
    upvar 1 1 y
    set y {}
...
proc masksend::unsetupvalues {numsyms} {
    for {set i 1} {$i <= $numsyms} {incr i} {
        upvar 1 $i y
        unset y
    }
    ...
    while {$accepted == 0} {
        ...
        switch -- $table($state:$token) {
            ...
            reduce {
                ...
                switch -- $rule {
                    1 { ProcessSendCmdGet mask color }
                    2 { ProcessSendCmdGet mask mark }
